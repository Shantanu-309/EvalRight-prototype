...
public class ClientController : ControllerBase
{
    ...
    public ClientController(IClientApplicantService applicantService)
    {
    ...
    /// </summary>
    [HttpGet("applicant/{candidateId}")]
    public async Task<IActionResult> GetApplicant(long candidateId)
    {
        try
        {
            // Extract clientId from JWT token claims
